...
conflictstufen[["development of a network/collective action"]] <- 0
...
conflictstufen[["objections to the eia"]] <- 2
conflictstufen[["creation of alternative reports/knowledge"]] <- 0
conflictstufen[["arguments for the rights of mother nature"]] <- 0
conflictstufen[["appeals/recourse to economic valuation of the environment"]] <- 0
conflictstufen[["strikes"]] <- 4
conflictstufen[["occupation of buildings/public spaces"]] <- 5
conflictstufen[["development of alternative proposals"]] <- 0
conflictstufen[["community-based participative research (popular epidemiology studies, etc)"]] <- 0
...
conflictstufen[["property damage/arson"]] <- 7
...
conflictstufen[["general assemblies, public forums or discussion tables"]] <- 2
...
conflictstufen[["new environmental impact assessment/study"]] <- 0
...
conflictstufen[["hunger strike"]] <- 4
...
conflictstufen[["migration/displacement"]] <- 5
conflictstufen[["new environmental impact assessment/study"]] <- 0
